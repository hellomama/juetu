...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ContactHolder>{
    ...
    public void setListener(OnClickListener aListener)
    {
        listener = aListener;
    }
    ...
    public void onBindViewHolder(@NonNull ContactAdapter.ContactHolder holder, int position) {
        ...
        holder.parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (listener != null)
                {
                    listener.onClick(jid.toString());
                }
//                XmppChatManager.getInstance().sendMessage();
